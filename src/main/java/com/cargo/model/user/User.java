...
public class User implements UserDetails {
    ...
    @Enumerated(EnumType.STRING) //храним енам в виде строки
    private Set<Role> roles;

    //бавляем обратную свзять для Many-to-one
    //cascade - при удалении польз.удаляются все его заказы
    //fetch - при загрузке пользователя все его заказы подгружаться не должны
